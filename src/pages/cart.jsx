        ...
        <div className="flex flex-col lg:flex-row gap-12 py-10">
          ...
          <div className="flex-[1]">
            ...
            <div className="p-5 my-5 bg-black/[0.5] rounded-xl">
              ...
              <div>
                The subtotal reflects the total price of your order, including duries and taxes, before any
...
{
  /* https://github.com/ShariqAnsari88/shoe-store-frontend/blob/main/components/ProductDetailsCarousel.jsx */
}
