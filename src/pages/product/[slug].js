      ...
      <Wrapper>
        ...
        mx-auto lg:mx-0"
          ...
          <div className="flex-[1] py-3">
            ...
            <button
              className="w-full py-4 rounded-full border border-black first-letter:text-lg
            font-medium transition-transform active:scale-95 flex items-center justify-center
            ...
            <div>
              ...
              <div className="markdown text-md mb-5">
                ...
                <p>
                  ...
                  Colour Shown: White/Black/Ice Blue Style: DV1308-104"
                </p>
              </div>
            </div>
          </div>
